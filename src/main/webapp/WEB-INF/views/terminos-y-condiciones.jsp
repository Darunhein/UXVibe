...
<div class="terminos-container">
    <main class="terminos-frame">
        ...
        <div class="buttons-section">
            <a id="btnMicrofono" class="btn-secondary" href="${pageContext.request.contextPath}/mic-test">Iniciar prueba de micrófono</a>
            <a id="btnComenzar" class="btn-primary disabled" href="${pageContext.request.contextPath}/test-recording">Comenzar prueba</a>
        </div>

        <a class="btn-back" href="${pageContext.request.contextPath}/tests">
            <img src="${pageContext.request.contextPath}/public/terminos y condiciones/lets-icons-back-light.svg" alt="Regresar" />
            <span>Regresar</span>
        </a>
    </main>
</div>
