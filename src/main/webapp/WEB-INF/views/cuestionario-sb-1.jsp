  ...
  <body data-context-path="${pageContext.request.contextPath}">
    <div class="questionnaire-container">
      <main class="questionnaire-frame">
        ...
        <form class="questionnaire-form" id="questionnaireForm" action="${pageContext.request.contextPath}/cuestionario-sb-1" method="post">
          <section class="form-section">
            <div class="form-row">
              <div class="form-group">
                <div class="input-label-group">
                  <img src="${pageContext.request.contextPath}/public/Cuestionario SB 1/merged-asset-1@2x.png" alt="Name icon" class="input-icon" />
                  <label for="fullName" class="input-label">Nombre completo</label>
                </div>
                <input type="text" id="fullName" name="fullName" class="form-input-name" placeholder="Escribe tu nombre completo" required />
              </div>
              <div class="form-group">
                <div class="input-label-group">
                  <label for="age" class="input-label">Edad</label>
                </div>
                <input type="number" id="age" name="age" class="form-input-age" placeholder="Ingresa tu edad" min="3" max="120" required />
              </div>
            </div>
          </section>
          ...
          <section class="form-section gender-section">
            <div class="section-header">
              <img src="${pageContext.request.contextPath}/public/Cuestionario SB 1/Group-49@2x.png" alt="Gender icon" class="section-icon" />
          ...
          <section class="form-section education-section">
            <div class="section-header">
              <img src="${pageContext.request.contextPath}/public/Cuestionario SB 1/Group-51@2x.png" alt="Education icon" class="section-icon" />
          ...
          <div class="survey-navigation">
            <a class="btn-back" id="sbBackButton" href="${pageContext.request.contextPath}/test-recording" aria-label="Regresar">
            ...
            <button type="submit" id="sbNextButton" class="btn-next" aria-label="Siguiente">
              <span>Siguiente</span>
              <img src="${pageContext.request.contextPath}/public/Cuestionario SB 1/carbon-next-outline.svg" alt="Next icon" />
            </button>
          </div>
        </form>
      </main>
