      ...
      <main class="frame">
        <section class="frame2">
          ...
          <div class="recuperar-contrasena-copy">
            <p>Ingresa tu email y enviamos un enlace para restablecer tu contraseña.</p>
          </div>
          ...
          <form action="${pageContext.request.contextPath}/recover" method="post">
            ...
            <section class="email-row">
              <div class="email-shell">
                ...
                <input id="recuperar-email" class="form-input email-input" placeholder="Ingresa tu email" type="email" name="email" autocomplete="email" required />
              </div>
            </section>
