  ...
  <body data-context-path="${pageContext.request.contextPath}" data-csrf="<%= mx.edu.utez.uxvibe.security.CsrfTokens.get(request) %>">
    <div class="microphone-test-container">
      <main class="microphone-test-frame">
        ...
        <div id="playback-widget" class="playback-widget">
          <div class="playback-widget-row">
            ...
            <div class="widget-seek-container">
              <input type="range" id="widget-seek-bar" class="widget-seek-bar" value="0" min="0" max="100" step="0.1"
            ...
            <div class="widget-volume-container">
              ...
              <input type="range" id="widget-volume-bar" class="widget-volume-bar" value="100" min="0" max="100"
                aria-label="Volumen" />
            </div>
          </div>
        </div>
        ...
        <a class="btn-back" href="${pageContext.request.contextPath}/terms"
          aria-label="Regresar a términos y condiciones">
          <img src="${pageContext.request.contextPath}/public/Prueba de Microfono/lets-icons-back-light.svg"
            alt="Back" />
          <span>Regresar</span>
        </a>
      </main>
