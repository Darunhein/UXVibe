      ...
      <main class="survey-frame">
        ...
        <div class="character-scale">
          <div class="character-item">
            <img src="${pageContext.request.contextPath}/public/SAM 3/image-25@2x.png" alt="Sin control" class="character" />
          </div>
          <div class="character-item">
            <img src="${pageContext.request.contextPath}/public/SAM 3/image-26@2x.png" alt="Bajo control" class="character" />
          </div>
          <div class="character-item">
            <img src="${pageContext.request.contextPath}/public/SAM 3/image-29@2x.png" alt="Moderado" class="character" />
          </div>
          <div class="character-item">
            <img src="${pageContext.request.contextPath}/public/SAM 3/image-28@2x.png" alt="Buen control" class="character" />
          </div>
          <div class="character-item">
            <img src="${pageContext.request.contextPath}/public/SAM 3/image-27@2x.png" alt="Total control" class="character" />
          </div>
        </div>
        ...
        <form class="survey-form" id="controlForm" action="${pageContext.request.contextPath}/sam-3" method="post">
          ...
          <div class="survey-navigation">
            <a class="btn-back" id="samBackButton" href="${pageContext.request.contextPath}/sam-2" aria-label="Regresar">
