    ...
    <div class="pantalla-escondida-de-prueba">
      <main class="frame">
        ...
        <section class="frame2" aria-label="Panel de grabación de prueba">
          ...
          <details class="pause-stack" id="pauseDetails">
            ...
            <div class="pause-menu" id="pauseMenu">
              <a class="pause-menu__item" id="startSurveyLink" href="${pageContext.request.contextPath}/cuestionario-sb-1">Empezar encuesta</a>
              <button class="pause-menu__item pause-menu__item--button" id="restartBtn" type="button">Reiniciar grabación</button>
        ...
        <a class="regresar" href="${pageContext.request.contextPath}/terms" aria-label="Regresar">
          <img class="lets-iconsback-light" src="${pageContext.request.contextPath}/public/Grabacion de prueba/lets-icons-back-light.svg" alt="" />
          <div class="regresar2">Regresar</div>
        </a>
      </main>

      <img class="merged-asset-1-icon" loading="lazy" alt="" src="${pageContext.request.contextPath}/public/Grabacion de prueba/merged-asset-1@2x.png" />
      <img class="merged-asset-2-icon" loading="lazy" alt="" src="${pageContext.request.contextPath}/public/Grabacion de prueba/merged-asset-2.svg" />
    </div>
