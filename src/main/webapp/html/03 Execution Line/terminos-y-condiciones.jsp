    ...
    <div class="terminos-container">
      <main class="terminos-frame">
        ...
        <div class="buttons-section">
          <a class="btn-secondary" href="${pageContext.request.contextPath}/html/03%20Execution%20Line/prueba-microfono.jsp">Iniciar prueba de micrófono</a>
          <a class="btn-primary" href="${pageContext.request.contextPath}/html/03%20Execution%20Line/grabacion-de-prueba.jsp">Comenzar prueba</a>
        </div>
