...
public class ConexionBD {
    ...
    private static final String JDBC_URL = "jdbc:oracle:thin:@" + "(description= (retry_count=20)(retry_delay=3)(address=(protocol=tcps)(port=1522)(host=adb.us-phoenix-1.oraclecloud.com))(connect_data=(service_name=gc5a7c8f4fbdb11_integradora_high.adb.oraclecloud.com))(security=(ssl_server_dn_match=yes)))";
