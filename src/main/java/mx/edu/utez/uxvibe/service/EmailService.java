  ...
  public static boolean sendPasswordResetLink(String to, String resetUrl) {
    ...
    try {
      ...
      String htmlContent = "<div style=\"font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);\">"
          ...
          "<a href=\"" + resetUrl
          + "\" target=\"_blank\" style=\"display: inline-block; background-color: #3f5669; color: #ffffff; font-size: 16px; font-weight: 600; text-decoration: none; padding: 14px 32px; border-radius: 8px; box-shadow: 0 4px 6px rgba(63, 86, 105, 0.25);\">Restablecer Contraseña</a>"
          +
          "</div>" +
          ...
          +
          "<p style=\"word-break: break-all; background-color: #f8fafc; padding: 12px; border-radius: 6px; border: 1px solid #e2e8f0; font-size: 12px; color: #244f6d; margin: 0 0 24px 0;\"><a href=\""
          + resetUrl + "\" style=\"color: #244f6d; text-decoration: underline;\">" + resetUrl + "</a></p>" +
