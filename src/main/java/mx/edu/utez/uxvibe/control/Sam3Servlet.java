...
@WebServlet(value = "/sam-3")
public class Sam3Servlet extends HttpServlet {

  private static final String VIEW = "/WEB-INF/views/sam-3.jsp";
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (control != null && !control.trim().isEmpty()) {
      ParticipantStore.getInstance().saveSurveyResponse(account.getEmail(), testName, participantName, "control", control.trim());
    }

    resp.sendRedirect(req.getContextPath() + "/encuesta-1");
  }
}
