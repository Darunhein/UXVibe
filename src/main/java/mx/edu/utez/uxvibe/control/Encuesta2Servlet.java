...
@WebServlet(value = "/encuesta-2")
public class Encuesta2Servlet extends HttpServlet {

  private static final String VIEW = "/WEB-INF/views/encuesta-2.jsp";
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    resp.sendRedirect(req.getContextPath() + "/encuesta-3");
  }
}
