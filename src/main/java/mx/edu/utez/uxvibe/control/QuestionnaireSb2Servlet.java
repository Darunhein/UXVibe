...
@WebServlet(value = "/cuestionario-sb-2")
public class QuestionnaireSb2Servlet extends HttpServlet {

  private static final String VIEW = "/WEB-INF/views/cuestionario-sb-2.jsp";
